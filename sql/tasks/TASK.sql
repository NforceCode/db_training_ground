...
CREATE TABLE "workers"(
  ...
  "birthday" date NOT NULL DEFAULT current_date - (integer '365' * 19) CHECK(
    "birthday" > '1930-1-1'
...
SELECT "salary", extract(year from age("birthday")) AS "age" 
FROM "workers" WHERE "name" = 'Zhenya';
...
DELETE FROM "workers" 
WHERE extract (year from age("birthday")) = 23 RETURNING *;
